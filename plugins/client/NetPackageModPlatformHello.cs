...
public sealed class NetPackageModPlatformHello : NetPackage
{
    ...
    public NetPackageModPlatformHello Setup(HandshakeHello hello)
    {
        ProtocolVersion = hello.ProtocolVersion;
        PluginVersion = hello.PluginVersion ?? "";
        GameVersion = hello.GameVersion ?? "";
        SteamBuildId = hello.SteamBuildId ?? "";
        PackId = hello.PackId ?? "";
        PackVersion = hello.PackVersion;
        KeyId = hello.KeyId ?? "";
        ArtifactFingerprint = hello.ArtifactFingerprint ?? "";
