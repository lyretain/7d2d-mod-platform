export function loadConfig(env = process.env) {
  ...
  return {
    ...
    launcherUrl: env.PUBLIC_LAUNCHER_URL || env.PUBLIC_BASE_URL || `http://localhost:${env.PORT || 8080}`,
    cdnBaseUrl: env.PUBLIC_CDN_URL || env.PUBLIC_BASE_URL || `http://localhost:${env.PORT || 8080}`,
